...
function OnPlayCiv6()
	...
	loadGame.Directory = SaveDirectories.DEMO;
	loadGame.Name = "Demo";
...
local m_defaultMainMenuOptions :table = {	
								...
								{label = "LOC_MAIN_MENU_DEMO_PURCHASE",		callback = OnShowStore,	tooltip = "LOC_MAIN_MENU_DEMO_PURCHASE_TT"},
